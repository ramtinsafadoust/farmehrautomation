...
@section('body')
                ...
                <form id="myForm" method="POST" dir="rtl" action="{{ route('edit') }}">
                        @csrf
                        <div class="row py-3">
                        ...
                        <div class="row py-3">
                            ...
                            <div class="form-group row col-lg-6 ">
                                ...
                                <div class="col-lg-9">
                                    <textarea id="accessories" class="form-control @error('accessories') is-invalid @enderror" name="accessories" value="{{ $data->accessories }}"  autocomplete="accessories" autofocus></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row py-3">
                        ...
                        <div class="form-group row col-lg-12 ">
                            <label for="p_id" class="col-lg-2 col-form-label text-md-right">وضعیت تعمیر دستگاه:</label>
